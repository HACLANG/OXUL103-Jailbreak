//forked from GeoSn0w's repository "iOS 10.1.1 project 0 exploit" - https://github.com/GeoSn0w/iOS-10.1.1-Project-0-Exploit-For-Jailbreak---F.C.E.-365-Fork-
//Credits @FCE365
iOS-10.1.1-Project-0-Exploit-For-Jailbreak---F.C.E.-365-Fork-/unsandboxer.c
7a0363d  on 19 Dec 2016
@GeoSn0w GeoSn0w Uploaded my Fork
1 contributor
RawBlameHistory    
181 lines (144 sloc)  6.5 KB
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
#include <unistd.h>
